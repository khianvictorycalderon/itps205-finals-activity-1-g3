# ITPS205 ReactJS Finals Activity 1
A simple mini activity for ITPS205.

## Members:
- Calderon, Khian Victory **(Team Leader)**
- Calderon, Nichole Allyson
- Cabana, Lovely Claire
- Alonzo, Sean
- Fernandez, Benedict
- Talento, Mark Angelo
- Tomo, Warren
...
2. Clone this repository by opening `git bash` or `cmd` on a folder where you want it to be stored (*`Example: D:\my-projects, Documents, Desktop, etc...`, its up to you*), and run this command `git clone https://github.com/khianvictorycalderon/itps205-finals-activity-1-g3.git`
3. Go to `itps205-finals-activity-1-g3` folder and open VS code inside it. After opening, you should see `public` and `src` folders and bunch of other files.
...
3. After commit, push your changes into the GitHub repository by running `git push -u origin <your-branch>`. Change the `<your-branch>` to the branch name I've given to you.
